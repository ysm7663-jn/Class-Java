...
/*
 * 메소드가 예외를 처리하는 방법 1. 직접 try - catch 문을 작성한다. (지금 고려할 대상이 아님) 2. 메소드를 호출하는 곳으로
 * 예외를 던진다.
 */
 ...
 * void a() { try {
 * 
 * } catch (Exception e) { } } void b() { try {
 * 
 * } catch (Exception e) { } } a(); b();
 */
////////////////////////////////////////////
 ...
 * }
 * 
 * try { a(); b(); } catch (Exception e) { e.printStackTrace(); }
 */
////////////////////////////////////////////
